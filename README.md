...
| [templates/skills/plan/](templates/skills/plan/) | Quality gate | Implementation-plan skill: pre-spec gate, mandatory sections (acceptance criteria, pillar alignment, design spec), red team + hold-out review agents. Fires before plan files are written. |
